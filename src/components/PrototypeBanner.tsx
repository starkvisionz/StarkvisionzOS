...
export function PrototypeBanner() {
  return (
    <div className="proto-banner">
      ...
      <span>
        <b>Prototype.</b> Chat, Timeline, Audit, Dashboard, Settings, the <b>Multi-agent loop</b>, <b>Nightshift</b>, <b>Model replay</b> and <b>Agent branches</b> are live — real Claude API + an event-sourced store. The remaining <b>Lab</b> views (graph, market, negotiation, and the rest) are interactive simulations, each labeled <i>Simulated</i>.
      </span>
    </div>
  );
}
